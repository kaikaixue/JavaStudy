package com.example.java.jfx.util;
...
public class SystemInfoUtil {
    ...
    public static JSONObject getCpuInfo() {
        ...
        cpuInfo.put("used", (1.0 - idle * 1.0 / totalCpu) * 100);
        cpuInfo.put("unused", (idle * 1.0 / totalCpu) * 100);
        return cpuInfo;
    }
    ...
    public static JSONObject getJvmInfo() {
        ...
        cpuInfo.put("used",(jvmTotalMemoryByte - freeMemoryByte) * 1.0 / jvmTotalMemoryByte * 100);
        cpuInfo.put("unused",(1 - (jvmTotalMemoryByte - freeMemoryByte) * 1.0 / jvmTotalMemoryByte)* 100) ;
        return cpuInfo;
    }
    ...
    public static JSONObject getMemInfo() {
        ...
        cpuInfo.put("usageRate", new
                ...
                totalByte));
        cpuInfo.put("isused",(totalByte - acaliableByte) * 1.0 / totalByte * 100);
        cpuInfo.put("unused", (1 - (totalByte - acaliableByte) * 1.0 / totalByte) * 100);
        return cpuInfo;
    }
