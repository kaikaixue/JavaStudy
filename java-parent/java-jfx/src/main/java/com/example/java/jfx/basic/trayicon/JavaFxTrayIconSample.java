package com.example.java.jfx.basic.trayicon;
...
public class JavaFxTrayIconSample extends Application {
     ...
     * 托盘图标
     */
    private static final String ICON_IMAGE = "https://cdn.jsdelivr.net/gh/kaikaixue/image-hosting@master/20211025/x.jpg";
    /**
     * 时间格式化
     */
    ...
    private Node createContent() {
        ...
        label.setStyle("-fx-font-size: 40px;-fx-text-fill: #b3e5fc");
