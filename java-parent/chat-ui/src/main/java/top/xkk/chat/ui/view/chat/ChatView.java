...
import top.xkk.chat.ui.view.chat.group_bar_friend.*;
...
public class ChatView {
    ...
    private void initAddFriendNew() {
        ...
        friendLuckSearch.setOnKeyPressed(event -> {
            if (event.getCode().equals(KeyCode.ENTER)) {
                ...
                // 添加朋友
                element.friendListView().getItems().add(new ElementFriendNewUser("001", "许老师", "https://javafx-study.oss-cn-hangzhou.aliyuncs.com/avatar/mqxu.jpg", 2).pane());
                element.friendListView().getItems().add(new ElementFriendNewUser("002", "王锋", "https://javafx-study.oss-cn-hangzhou.aliyuncs.com/avatar/wf.jpg", 2).pane());
                element.friendListView().getItems().add(new ElementFriendNewUser("007", "杨阳", "https://javafx-study.oss-cn-hangzhou.aliyuncs.com/avatar/yy.jpg", 2).pane());
            }
        });
    }
    ...
    void setContentPaneBox(String id, String name, Node node) {
        ...
        // 对话框名称
        Label infoName = chatInit.$("info_name", Label.class);
