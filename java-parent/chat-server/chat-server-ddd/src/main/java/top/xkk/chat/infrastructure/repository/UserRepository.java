...
import top.xkk.chat.domain.user.model.*;
import top.xkk.chat.domain.user.repository.IUserRepository;
import top.xkk.chat.infrastructure.dao.*;
import top.xkk.chat.infrastructure.po.*;

import java.util.ArrayList;
import java.util.List;

import static top.xkk.chat.infrastructure.common.Constants.TalkType.Friend;
import static top.xkk.chat.infrastructure.common.Constants.TalkType.Group;
